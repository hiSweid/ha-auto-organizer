...
### Added
- 134 new keywords/icons across **config/settings**, **diagnostics**,
  **sun-position astronomy terms**, plus misc device/brand synonyms and MDI
  icon backfills.
...
### Added
- 277 new keywords/icons across **config/settings**, **diagnostics/health**,
  **sun-position astronomy terms**, plus misc device/brand synonyms and MDI
  icon backfills.
...
### Added
- 144 new keywords/icons across **sun**, **mower**, **shopping**, plus a
  general icon-scan and device-synonym backfill.
